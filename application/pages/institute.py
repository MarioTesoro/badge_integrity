...
if selected == options[0]:
    ...
    if submit:
        ...
        print("data_to_hash:",data_to_hash)
        ...
        st.success(f"Certificate successfully generated at: http://127.0.0.1:8501/verify_certificate?ipfs_hash={ipfs_hash}&cert_id={certificate_id}")
